...
const eventTypes = sql`('STREAM_STARTED', 'STREAM_ENDED', 'COMMENT', 'LIKE', 'GIFT', 'VIEWER_SPIKE', 'VIEWER_DROP', 'COMMENT_ACTIVITY_SPIKE', 'GIFT_ACTIVITY_SPIKE', 'MONITORING_FAILED', 'MONITORING_RECOVERED', 'CONNECTION_LOST', 'CONNECTION_RECOVERED')`;
